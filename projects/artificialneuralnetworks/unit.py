...
class Unit:
    ...
    def __init__(self, activation=0.0, name='node', type='input'):
        ...
        self.name = name
        assert type == 'input' or type == 'hidden' or type == 'output'  # Must be one of these 3
        self.type = type
    ...
    def updateDelta(self, target=None):
        ...
        elif self.type=='hidden' or self.type=='input': # TODO: Make exclusive to hidden and input nodes
            delta = 0
